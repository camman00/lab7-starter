...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		this.shadowDom.appendChild(this.styleEl);
		this.shadowDom.appendChild(this.articleEl);
	}
	...
	set data(data) {
		...
		// We already store the reference in the class itself :)
		...
		// `` is the best thing I found today
